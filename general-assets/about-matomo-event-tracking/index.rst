...
Prequisites: The tenant feature "Analytics core setup" must be active and "Enable data collection" must be on for the business profiles you want to track. If SharePoint should be tracked, the feature "Analytics for SPFx" must be activated for the applicable publishing apps.
