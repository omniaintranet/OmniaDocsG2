...
For semantic search to work, pages and documents must be indeexed. A prerequisite for semantic search is therefore Sharepoint sync. It's needed to be able to index page collections. Fins these settings on page collection level for pages, and in document types for controlled documents. Semantic search does not work for other types of documents yet. 
