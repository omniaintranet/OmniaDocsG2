...
**Work on this page is just started. This page will describe all available options in the block.**
...
Page types can be created for the Content builder, containing some settingts for the block. See this page for more information: (link to be added).

Some settings for the block can also be made by an editor. For the block settings, see: (link to be added)

**The following is basic text that will be edited in the weeks to come. It does not list the actual optiopns yet.**

Here's a common example of available options in the content builder:
