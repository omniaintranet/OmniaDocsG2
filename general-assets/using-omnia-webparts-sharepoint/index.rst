...
There's also another way of doing this. If you’re using SharePoint pages in an Omnia implementation, you can use all blocks defined in the webparts section, on ANY SharePoint page. These webparts (blocks) are described on this page, together with a description on how to use them: :doc:`Webparts </admin-settings/tenant-settings/system/microsoft-365/system-webparts>`
...
No you can find the webparts in the toolbox, for example:
