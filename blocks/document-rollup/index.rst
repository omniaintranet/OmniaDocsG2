...
The Analytics options can be available if Matomo analytics is active in the tenant. More info at the bottom of the page.

General
-----------------
Here you can add a block title if needed, and choose how a document should be opened from this rollup:
