...
+ **Open in new tab**: Available in Omnia 7.9 and later. Now you can decide if for example settings should be opened in a new tab or not. Note that it doesn't work well to open in new tab in Omnia Feed, so if this rollup is used there, this option should not be activated.
