...
Under Settings for Tenant, the following options are available:
...
.. toctree::
   ...
   tenant-settings-rtf-editor/index
   tenant-settings-media-picker/index
   tenant-settings-redirect/index
