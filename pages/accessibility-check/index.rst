...
When you are editing a page, you can use **Preview mode** to check for accessibility issues, including readability. This option must be activated for each page collection, using the page collection settings. Meaning, it can be activated for just some page collections, if needed. For more information, see: :doc:`Page collection settings </pages/page-collections/page-collection-settings/index>`
