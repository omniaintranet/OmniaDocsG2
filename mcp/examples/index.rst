...
+ **You will be asked which part of Omnia you mean.** Most actions need a scope: the whole tenant, one business profile, one Publishing App, one page collection or one page. When it is missing, the connector offers the candidates as a list - up to 50 of them, and it tells you when there are more than it could show. You can save a round trip, or reach one that is not in the list, by pasting a URL into your prompt.
