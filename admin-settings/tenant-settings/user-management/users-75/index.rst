...
This pages describes the tenant options for Users in Omnia 7.7 and earlier. For Omnia 7.8 and later, see this page: :doc:`User management users in Omnia 7.8 </admin-settings/tenant-settings/user-management/users-78/index>`
