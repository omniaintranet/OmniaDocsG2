...
+ **Target channel to specific editors**: Available in Omnia 7.10 and later. If you use this option for a channel, only the editors targeted can see and use the channel.
