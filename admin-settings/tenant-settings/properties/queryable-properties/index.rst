...
When a rollup is set up, editors can choose an A-Z property, as in this example (Page rollup) where "Titel (A-Z)" has been added as a filter. This is the setting in the example image above.
