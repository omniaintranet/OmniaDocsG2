...
Here's an example of an app launcher in Omnia 7.12:

.. image:: omnia-app-launcher-example-v712.png
...
Query
********
Use the following settings for Query:

.. image:: app-launcher-settings-query-v712.png
...
+ **Include followed links**: Users can follow links in My links. If these links should be available in the App launcher as well, select this option. Note that one or more categories that contain followed links will have to be selected below, for any followed links to show up.
...
Display
*******
These settings can be used for Display:

.. image:: app-launcher-settings-display-v712.png
...
.. image:: app-launcher-settings-custom-colors-712.png
...
Note the Save bottom at the end of the list (not shown in the image above).
