...
--------------------------------------
Semantic search is an AI feature that can be available in Omnia if semantic search is activated in the tenant. Add the colleagues and groups that should be able to use semantic search. 
