...
**Note!** In Omnia 7.8 and later, this footer can be enabled in connected SharePoint sites. It's a feature you can active for the apps where you want this. For more information, see: :doc:`App settings </admin-settings/app-settings/index>`
